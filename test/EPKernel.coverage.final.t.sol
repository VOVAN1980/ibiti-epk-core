...
contract EPKernelCoverageFinalTailTest is EPKernelCoverageExtraTest {
    ...
    vm.prank(owner);
    kernel.setPolicyActive(id, false); // pass Р В Р’В Р В РІР‚В Р В Р’В Р вЂ™Р’ВµР В Р Р‹Р Р†Р вЂљРЎв„ўР В Р’В Р РЋРІР‚СњР В Р’В Р вЂ™Р’В° line 114
}
...
function testOnlyPolicyOwner_fail_setPolicyActive_notOwner() public {
    ...
    kernel.setPolicyActive(id, false); // fail Р В Р’В Р В РІР‚В Р В Р’В Р вЂ™Р’ВµР В Р Р‹Р Р†Р вЂљРЎв„ўР В Р’В Р РЋРІР‚СњР В Р’В Р вЂ™Р’В° line 114
}
